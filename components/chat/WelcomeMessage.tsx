    ...
    <div className="h-full flex flex-col justify-end pb-4 px-4">
      ...
      >
        ...
        <p className="text-[#b5bac1] text-base">
          This is the start of the #{channelName} channel. No messages yet—be
          the first to say hi!
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="text-sm text-[#87888c]"
      >
        <p className="mb-1">
          💡 <strong>Pro tip:</strong> You can edit messages by double-clicking
          them
        </p>
        <p>
          ⌨️ <strong>Keyboard shortcut:</strong> Press Cmd/Ctrl + K to search
        </p>
      </motion.div>
    </div>
  );
